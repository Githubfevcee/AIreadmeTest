...
- Machine learning agents toolkit release version 20[^6] and later Machine learning agents toolkit release developer branch[^19]
- Unity 2021.3.14f1[^7]
- Python 3.9.12[^8]
...
[^19]:https://github.com/Unity-Technologies/ml-agents/tree/develop
